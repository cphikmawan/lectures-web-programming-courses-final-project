            ...
            <div class="row">
                <div class="col-md-9 page-content">
                    <div class="inner-box category-content">
                        <h2 class="title-2 uppercase"><strong> <i class="icon-briefcase"></i> Edit a Job </strong></h2>
                            ...
                            <div class="col-sm-12">
                                ...
                                {{csrf_field()}}
                                    ...
                                    <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8">
                                            <input id="title" type="text" class="form-control input-md" value="{{$jobb->title}}" placeholder="Job Title" name="title" required>
                                    ...
                                    <div class="form-group{{ $errors->has('desc') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <textarea name="desc" value="{{$jobb->desc}}" class="form-control my-editor"></textarea>
                                            <script>
                                              var editor_config = {
                                                path_absolute : "/",
                                    ...
                                    <div class="form-group{{ $errors->has('position') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8">
                                            <input id="position" placeholder="Job Position" value="{{$jobb->position}}" type="text" class="form-control input-md" name="position" required>
                                    ...
                                    <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8">
                                            <input id="city" placeholder="City" type="text" value="{{$jobb->city}}" class="form-control input-md" name="city" required>
                                    ...
                                    <div class="form-group{{ $errors->has('salary') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                ...
                                                <input id="salary" placeholder="Salary" type="text" value="{{$jobb->salary}}" class="form-control input-md" name="salary" required>
                                            </div>
